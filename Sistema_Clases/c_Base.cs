namespace Sistema_Clases
{
    ...
    public class c_Base
    {
        ...
        {
            var cnn = new SqlConnection(Sistema_Clases.Sistema.dbDatosConnectionString);
        ...
        public bool Existe()
        {
            ...
            SqlConnection cnn = new SqlConnection(Sistema_Clases.Sistema.dbDatosConnectionString);
            var dt = new DataTable("Datos");
